...
type DemoServiceClient interface {
	Poke(ctx context.Context, in *Finger, opts ...grpc.CallOption) (*Reaction, error)
}
...
func (c *demoServiceClient) Poke(ctx context.Context, in *Finger, opts ...grpc.CallOption) (*Reaction, error) {
	out := new(Reaction)
	err := c.cc.Invoke(ctx, "/DemoService/Poke", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DemoServiceServer interface {
	Poke(context.Context, *Finger) (*Reaction, error)
...
func (UnimplementedDemoServiceServer) Poke(context.Context, *Finger) (*Reaction, error) {
...
func _DemoService_Poke_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Finger)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DemoServiceServer).Poke(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/DemoService/Poke",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DemoServiceServer).Poke(ctx, req.(*Finger))
	}
...
var DemoService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Poke",
			Handler:    _DemoService_Poke_Handler,
		},
	},
